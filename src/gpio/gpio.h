...
typedef struct
{
	enum GPIO_INPUT_DATA pin0 : 1;
	enum GPIO_INPUT_DATA pin1 : 1;
	enum GPIO_INPUT_DATA pin2 : 1;
	enum GPIO_INPUT_DATA pin3 : 1;
	enum GPIO_INPUT_DATA pin4 : 1;
	enum GPIO_INPUT_DATA pin5 : 1;
	enum GPIO_INPUT_DATA pin6 : 1;
	enum GPIO_INPUT_DATA pin7 : 1;
	enum GPIO_INPUT_DATA pin8 : 1;
	enum GPIO_INPUT_DATA pin9 : 1;
	enum GPIO_INPUT_DATA pin10 : 1;
	enum GPIO_INPUT_DATA pin11 : 1;
	enum GPIO_INPUT_DATA pin12 : 1;
	enum GPIO_INPUT_DATA pin13 : 1;
	enum GPIO_INPUT_DATA pin14 : 1;
	enum GPIO_INPUT_DATA pin15 : 1;
	uint32_t			 reserved : 16;
...
{
	GPIO_OUTPUT_LOW	 = 0b0,
	GPIO_OUTPUT_HIGH = 0b1,
};
typedef struct
{
	enum GPIO_OUTPUT_DATA pin0 : 1;
	enum GPIO_OUTPUT_DATA pin1 : 1;
	enum GPIO_OUTPUT_DATA pin2 : 1;
	enum GPIO_OUTPUT_DATA pin3 : 1;
	enum GPIO_OUTPUT_DATA pin4 : 1;
	enum GPIO_OUTPUT_DATA pin5 : 1;
	enum GPIO_OUTPUT_DATA pin6 : 1;
	enum GPIO_OUTPUT_DATA pin7 : 1;
	enum GPIO_OUTPUT_DATA pin8 : 1;
	enum GPIO_OUTPUT_DATA pin9 : 1;
	enum GPIO_OUTPUT_DATA pin10 : 1;
	enum GPIO_OUTPUT_DATA pin11 : 1;
	enum GPIO_OUTPUT_DATA pin12 : 1;
	enum GPIO_OUTPUT_DATA pin13 : 1;
	enum GPIO_OUTPUT_DATA pin14 : 1;
	enum GPIO_OUTPUT_DATA pin15 : 1;
	uint32_t			  reserved : 16;
